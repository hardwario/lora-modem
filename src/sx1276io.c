...
{
    gpio_set_irq(RADIO_DIO_0_PORT, RADIO_DIO_0_PIN, SX1276IO_IRQ_PRIORITY, irq[0]);
    gpio_set_irq(RADIO_DIO_1_PORT, RADIO_DIO_1_PIN, SX1276IO_IRQ_PRIORITY, irq[1]);
    gpio_set_irq(RADIO_DIO_2_PORT, RADIO_DIO_2_PIN, SX1276IO_IRQ_PRIORITY, irq[2]);
    gpio_set_irq(RADIO_DIO_3_PORT, RADIO_DIO_3_PIN, SX1276IO_IRQ_PRIORITY, irq[3]);
    gpio_set_irq(RADIO_DIO_4_PORT, RADIO_DIO_4_PIN, SX1276IO_IRQ_PRIORITY, irq[4]);
}
...
void SX1276Reset(void)
{
    ...
    gpio_init(RADIO_RESET_PORT, RADIO_RESET_PIN, &cfg);
...
{
    uint32_t mask;
    if (sx1276io_radio_is_active == status) return;
    ...
    if (status == false) {
        ...
        gpio_init(RADIO_ANT_SWITCH_PORT_RX, RADIO_ANT_SWITCH_PIN_RX, &cfg);

        gpio_write(RADIO_ANT_SWITCH_PORT_TX_BOOST, RADIO_ANT_SWITCH_PIN_TX_BOOST, 0);
        gpio_init(RADIO_ANT_SWITCH_PORT_TX_BOOST, RADIO_ANT_SWITCH_PIN_TX_BOOST, &cfg);

        gpio_write(RADIO_ANT_SWITCH_PORT_TX_RFO, RADIO_ANT_SWITCH_PIN_TX_RFO, 0);
        gpio_init(RADIO_ANT_SWITCH_PORT_TX_RFO, RADIO_ANT_SWITCH_PIN_TX_RFO, &cfg);
